...
import { ArrowUpRight, Github, Linkedin, Mail, Cpu } from 'lucide-react';
...
const highlights: Highlight[] = [
  ...
  },
  {
    title: 'Availability',
    description:
      'Open to full-time SWE & AI roles for 2025 · Based in Bangalore, India · Open to remote & relocation.',
  },
];
          ...
          <div className="relative grid gap-12 lg:grid-cols-2">
            ...
            <div className="space-y-8">
              ...
              <div className="space-y-4">
                ...
                >
                  J Madhav Pai, AI Engineer & Full-Stack Developer
                </motion.h2>
                <motion.p
                  initial={{ opacity: 0, y: 20 }}
                  whileInView={{ opacity: 1, y: 0 }}
                ...
                >
                  Third-year CS & Business Systems student at BMSCE Bangalore
                  with a 9.4 CGPA. Currently building AI training infrastructure
                  at Cynepia Technologies — bridging benchmark datasets and
                  reinforcement learning environments for agentic models.
                </motion.p>
              </div>
              ...
              >
                <Button
                  size="lg"
                  onClick={() =>
                    window.open('https://github.com/madhavpai09', '_blank')
                  }
                ...
                <Button
                  ...
                  variant="outline"
                  onClick={() =>
                    window.open('mailto:jmadhavpai@gmail.com', '_blank')
                  }
              ...
              <div className="relative flex h-full flex-col justify-between overflow-hidden rounded-[28px] border border-border/50 bg-background/60 p-8 backdrop-blur-xl">
                <div className="flex flex-col items-center text-center">
                  ...
                  >
                    ...
                    <div className="relative flex h-32 w-32 items-center justify-center rounded-full border border-border/40 bg-gradient-to-br from-cyan-400/20 to-violet-400/20 shadow-[0_25px_60px_rgba(0,0,0,0.5)]">
                  ...
                  >
                    {['9.4 CGPA', 'BMSCE', 'Cynepia Technologies'].map((tag) => (
                      <span
                        key={tag}
                  ...
                  >
                    Building systems that think, scale, and ship — from RL
                    training pipelines to full-stack products.
                  </motion.p>
                </div>
                    ...
                    return (
                      ...
                      >
                        <div className="flex items-center gap-3">
                          <span className="flex h-10 w-10 items-center justify-center rounded-full border border-border/40 bg-background/70 text-foreground/80 shadow-[0_10px_30px_rgba(0,0,0,0.4)] transition-all group-hover:shadow-[0_10px_30px_rgba(0,0,0,0.5)]">
